...
class CameraSystem:
    ...
    def capture_image(self, plant_folder, plant_name, the_time, camera_id, image_folder):
        ...
        cmd = f"libcamera-still -o /home/pi/Images/{plant_folder}/{image_folder}/{file_name}"
    ...
    def select_camera(self, cam_id):
        ...
        pin_states = camera_pins[cam_id]
        i2c_command = f"i2cset -y 1 0x70 0x00 {pin_states[3]}"
        self.execute_ssh_command(i2c_command)
        self.execute_ssh_command(f"gp.output(7, {pin_states[0]})")
        self.execute_ssh_command(f"gp.output(11, {pin_states[1]})")
        self.execute_ssh_command(f"gp.output(12, {pin_states[2]})")
